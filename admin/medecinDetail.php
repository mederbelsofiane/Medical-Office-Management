...
<?php    $id_medecin = $_GET['id_medecin'] ?? false;
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="font-weight-bold ml-3">
              <h3 class="text-info">Detail Du medecin : </h3><h3><?php echo  h($medecin->nom_medecin). "  " . ($medecin->prenom_medecin);  ?></h3>
            </div>
            ...
            <div class="">
              <a class="btn btn-warning px-4 mt-2 mr-2" href="modifierMedecin.php?id_medecin=<?php echo ($medecin->id_medecin);?>
                ...
                <a class="btn btn-danger px-4 mt-2 ml-2" href="suprimerMedecin.php?id_medecin=<?php echo ($medecin->id_medecin);?>
