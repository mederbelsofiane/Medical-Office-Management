...
if(mysqli_num_rows($result) > 0)
{
    ...
    $output.='<td class="text-center  text-light"><a href="dossierPatient.php?id_patient='.$id.'" name="button" class="btn btn-info" >Voir Dossier</a></td>
              ...
              <td class="text-center  text-light"><a href="modifierPatient.php?id_patient='.$id.'" name="button" class="btn btn-warning" >Modifier</a></td>
              <td class="text-center  text-light"><a href="suprimerPatint.php?id_patient='.$id.'" name="button" class="btn btn-danger" >Suprimer</a></td>
