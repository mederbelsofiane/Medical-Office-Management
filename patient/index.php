              ...
              <div class="row pt-md-5 mt-md-3 mb-5">
                <div class="col-md-12 text-center ">
                  <div class="font-weight-bold ml-2">
                    <h3 class="text-secondary"> Bienvenu dans votre Panel Patient : </h3>
                    <h2>
                      <?php
                      $result = Patient::find_all_dossier_patient_date();
                      ?>
                      <?php   while($row = $result->fetch_assoc())
                      {   if ($id_patient == $row['id_patient']) {
                      echo $row['nom_patient']." ".$row['prenom_patient'];
                    }}?>.</h2>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="font-weight-bold ml-2">
                    <h3 class="text-info"><i class="far fa-address-book fa-lg pb-1"></i> Mes Dossiers : </h3>
                  </div>
