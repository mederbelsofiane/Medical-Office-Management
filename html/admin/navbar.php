      ...
      <div class="row">
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top  top-navbar">
          ...
          <ul class="navbar-nav flex-column mt-4 ">
            ...
            <li class="nav-item"><a href="urgence.php" class="nav-link text-white p-3 mb-2 sidebar-link text-danger">
              <i class="fas fa-ambulance text-danger fa-lg mr-3"></i>Urgence</a></li>

            <li class="nav-item"><a href="patients.php" class="nav-link text-white p-3 mb-2 sidebar-link">
              <i class="fas fa-users text-light fa-lg mr-3"></i>Patients</a></li>

            <li class="nav-item"><a href="dossiers.php" class="nav-link text-white p-3 mb-2 sidebar-link">
              <i class="far fa-address-book text-light fa-lg mr-3"></i>Dossiers</a></li>

            <li class="nav-item"><a href="rendez-vous.php" class="nav-link text-white p-3 mb-2 sidebar-link">
              <i class="far fa-calendar-check text-light fa-lg mr-3"></i>Rendez-vous</a></li>

            <li class="nav-item"><a href="medecins.php" class="nav-link text-white p-3 mb-2 sidebar-link">
              <i class="fas fa-user-md text-light fa-lg mr-3"></i>Medecins</a></li>

            <li class="nav-item"><a href="secretaires.php" class="nav-link text-white p-3 mb-2 sidebar-link">
              <i class="fas fa-users-cog text-light fa-lg mr-3"></i>Secretaires</a></li>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-3">
              <ul class="navbar-nav">
                ...
                <?php if ($session_secretaire->is_logged_in()) {
                ?>
                <li class="nav-item ml-md-auto border border-danger rounded ">

                  <a href="../secretaireLogout.php"
