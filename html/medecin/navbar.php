        ...
        <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top  top-navbar ">
          <br>
                <div class="text-center">
                  <i class="fa fa-user-md fa-4x text-light"></i>

                </div>
          <a href="index.php" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-4 bottom-border font-weight-bold">
            <h3 class="font-weight-bold">
              <?php if ($session_medecin->is_logged_in()) {
                echo $session_medecin->nom_medecin;
               ?></h3>
               <h3 class="font-weight-bold"><?php echo $session_medecin->prenom_medecin; ?></h3>
               <h3 class="font-weight-bold"><?php echo "(".$session_medecin->specialite.")";} ?></h3>
             </a>
            ...
            <div class="col-md-3">
              <ul class="navbar-nav">
                ...
                <li class="nav-item ml-md-auto border border-light rounded ">
                  <a href="../medecinLogout.php" class="nav-link text-light font-weight-bold p-2">
                    Se Déconnecter </a></li>
                    <?php  } ?>
              </ul>
            </div>
