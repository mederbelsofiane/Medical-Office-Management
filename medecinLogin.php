...
if(is_post_request()) {
  ...
  // if there were no errors, try to login
    ...
    if($medecin != false && ($pass==$medecin->pass)) {
      // Mark admin as logged in
      $session_medecin->login($medecin);

      redirect_to('medecin/index.php');
    } else {
...
<body id="patient-background">
  ...
  <div class="container">
      <div class="row justify-content-md-center">
        ...
        <form action="medecinLogin.php" class="login-form" method="post" enctype="multipart/form-data">
          <div class="form">
